! function(t) {
    ...
    r.env.safari = /safari/.test(_) && !I && !m, y && s.on("touchstart mousedown", function(t) {
        g = t.target
    ...
    r.resize = O(c, "resize.webflow orientationchange.webflow load.webflow"), r.scroll = O(c, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), r.redraw = O(), r.location = function(t) {
        window.location = t
        ...
        t = t || {}, v = !0, c.triggerHandler("__wf_destroy"), null != t.domready && (p = t.domready), l.each(i, h), r.resize.off(), r.scroll.off(), r.redraw.off(), o = [], a = [], "pending" === T.state() && S()
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = E, e.removeAt = h, e.replaceAt = g, e.getIn = _, e.set = y, e.setIn = I, e.update = m, e.updateIn = T, e.merge = O, e.mergeDeep = b, e.mergeIn = S, e.omit = R, e.addDefaults = A;
    var i = "INVALID_ARGS";
    ...
    window.tram = function(t) {
        ...
        if (C.transition) {
            var P = C.timing.dom;
            if (A.style[P] = l["ease-in-back"][0], !A.style[P])
                for (var x in d) l[x][0] = d[x]
        }
        var D = e.frame = function() {
            ...
            F = f(function(e) {
                ...
                e.init = function(e) {
                    ...
                    C.backface && z.hideBackface && W(this.el, C.backface.css, "hidden")
                    ...
                    u.call(this, t), p.call(this, t, h, _)
                }), y("show", function(t) {
            ...
            U = f(function(t) {
                ...
                t.init = function(t, e, n, r) {
                    ...
                    return function(t, e) {
                        s("Type warning: Expected: [" + i + "] Got: [" + (0, r.default)(e) + "] " + e)
                    }(0, t), t
                }, t.redraw = function() {
                    this.el.offsetHeight
                }
            ...
            j = f(U, function(t, e) {
                ...
                t.init = function() {
                    e.init.apply(this, arguments), this.current || (this.current = {}, q.perspective && z.perspective && (this.current.perspective = z.perspective, W(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function(t) {
        ...
        C.transform && (Q.transform = [j], q = {
            ...
            skewX: [T],
            skewY: [T]
        }), C.transform && C.backface && (q.z = [m, "translateZ"], q.rotateZ = [T], q.scaleZ = [_], q.perspective = [I]);
        var $ = /ms/,
            Z = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    t.exports = function(t, e, n, a, u, c) {
        ...
        for (c.set(t, e), c.set(e, t); ++p < f;) {
            var h = t[p],
                g = e[p];
            if (a) var _ = s ? a(g, h, p, e, t, c) : a(h, g, p, t, e, c);
            if (void 0 !== _) {
                if (_) continue;
                v = !1;
                break
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        return 0 === e ? 0 : 1 === e ? 1 : o(e > 0 && t && i[t] ? i[t](e) : e)
    };
    var i = r(n(84));
    ...
    "use strict";
    e.__esModule = !0;
    var r, i = (r = n(197)) && r.__esModule ? r : {
        default: r
    };
    e.default = i.default
}, function(t, e, n) {
    ...
    var a = o(n(26)),
        ...
        z = D.reduceListToGroup,
        W = D.shouldNamespaceEventParameter,
                ...
                i ? function(t) {
                    ...
                    if ((0, f.default)(d)) {
                        (0, v.default)(d, function(t, e) {
                            ...
                            ($(p, u.mediaQueryKeys) || n.dispatch((0, y.mediaQueriesDefined)()), a.actionTypeId === x) && (Array.isArray(o.config) ? o.config : [o.config]).forEach(function(e) {
                            ...
                            (a.actionTypeId === P || ut(a.actionTypeId)) && yt({
                                store: n,
                                actionListId: v,
                                eventId: f
                            })
                        ...
                        var p = function(t) {
                                ...
                                gt(d, function(r, o, c) {
                                    ...
                                    if (K(p, e.mediaQueryKey)) {
                                        ...
                                        if (l.actionTypeId === x)(Array.isArray(s.config) ? s.config : [s.config]).forEach(v);
                                        else v()
                                    }
                                })
                            },
    ...
    function Ot(t) {
        ...
        e.dispatch((0, y.instanceAdded)((0, a.default)({
            ...
            t.dispatch((0, y.instanceStarted)(e, 0)), t.dispatch((0, y.animationFrameChanged)(performance.now(), n)), Rt(t.getState().ixInstances[e], t)
        }(e, l) : (U({
            store: e,
            select: function(t) {
        ...
        if (K(S, O.mediaQueryKey) && (r || n || i)) {
            ...
            if (i) {
                if (E) {
                    ...
                    g && !x && e.dispatch((0, y.actionListPlaybackChanged)({
                        actionListId: v,
                        isPlaying: !1
                    }))
                }
    ...
    n(100), n(102), n(54), n(104), n(257), n(258), n(259), n(260), t.exports = n(265)
}, function(t, e, n) {
    "use strict";
    var r = n(5);
    ...
    t.exports = function(t, e, n, E, h, g) {
        var _ = c(t),
            y = c(e),
            I = _ ? d : u(t),
            m = y ? d : u(e),
        ...
        if (b && !T) return g || (g = new r), _ || f(t) ? i(t, e, n, E, h, g) : o(t, e, I, n, E, h, g);
        if (!(1 & n)) {
            var S = T && v.call(t, "__wrapped__"),
                R = O && v.call(e, "__wrapped__");
            if (S || R) {
                var A = S ? t.value() : t,
                    w = R ? e.value() : e;
                return g || (g = new r), h(A, w, n, E, g)
            }
        }
        return !!b && (g || (g = new r), a(t, e, n, E, h, g))
    }
}, function(t, e, n) {
    var r = n(33),
        i = n(151),
    ...
    t.exports = function(t, e, n, o, a, u) {
        ...
        for (var E = c; ++l < f;) {
            var h = t[d = s[l]],
                g = e[d];
            if (o) var _ = c ? o(g, h, d, e, t, u) : o(h, g, d, t, e, u);
            if (!(void 0 === _ ? h === g || a(h, g, n, o, u) : _)) {
                v = !1;
                break
            }
            E || (E = "constructor" == d)
        ...
        if (v && !E) {
            var y = t.constructor,
                I = e.constructor;
            y != I && "constructor" in t && "constructor" in e && !("function" == typeof y && y instanceof y && "function" == typeof I && I instanceof I) && (v = !1)
        }
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        switch (o) {
            ...
            case I.STYLE_SIZE:
                var u = i(t, _.WIDTH),
                    c = i(t, _.HEIGHT);
                return {
                    widthValue: a.widthUnit === _.AUTO ? C.test(u) ? parseFloat(u) : parseFloat(n.width) : (0, f.default)(parseFloat(u), parseFloat(n.width)), heightValue: a.heightUnit === _.AUTO ? C.test(c) ? parseFloat(c) : parseFloat(n.height) : (0, f.default)(parseFloat(c), parseFloat(n.height))
                };
            case I.STYLE_BACKGROUND_COLOR:
            case I.STYLE_BORDER:
            case I.STYLE_TEXT_COLOR:
                return function(t) {
                    var e = t.element,
                        ...
                        a = function(t, e) {
                            var n = V.exec(e);
                            return n ? n[1] : ""
                        }(0, G.test(o) ? o : n[i]).split(_.COMMA_DELIMITER);
                    return {
                        rValue: (0, f.default)(parseInt(a[0], 10), 255),
                        gValue: (0, f.default)(parseInt(a[1], 10), 255),
                        bValue: (0, f.default)(parseInt(a[2], 10), 255),
                        aValue: (0, f.default)(parseFloat(a[3]), 1)
                    }
                }({
                    element: t,
                    actionTypeId: o,
        ...
        switch (i) {
            ...
            case I.STYLE_SIZE:
                ...
                if (f === _.AUTO) {
                    var E = a(e, _.WIDTH);
                    u(e, _.WIDTH, ""), p = c(e, "offsetWidth"), u(e, _.WIDTH, E)
                }
                if (l === _.AUTO) {
                    var h = a(e, _.HEIGHT);
                    u(e, _.HEIGHT, ""), v = c(e, "offsetHeight"), u(e, _.HEIGHT, h)
                }
                return {
            ...
            case I.STYLE_FILTER:
                return n.config.filters.reduce(x, {});
            default:
                return {
        ...
        switch (u) {
            case _.RENDER_TRANSFORM:
                return function(t, e, n, r, i) {
                    var o, a, u, c, s, f = U.map(function(t) {
                            var n = M[t],
                                r = e[t] || {},
                                i = r.xValue,
                            ...
                            switch (t) {
                                case I.TRANSFORM_MOVE:
                                    return "".concat(_.TRANSLATE_3D, "(").concat(o).concat(l, ", ").concat(u).concat(p, ", ").concat(s).concat(E, ")");
                                case I.TRANSFORM_SCALE:
                                    return "".concat(_.SCALE_3D, "(").concat(o).concat(l, ", ").concat(u).concat(p, ", ").concat(s).concat(E, ")");
                                case I.TRANSFORM_ROTATE:
                                    return "".concat(_.ROTATE_X, "(").concat(o).concat(l, ") ").concat(_.ROTATE_Y, "(").concat(u).concat(p, ") ").concat(_.ROTATE_Z, "(").concat(s).concat(E, ")");
                                case I.TRANSFORM_SKEW:
                        ...
                        l = i.setStyle;
                    j(t, m.TRANSFORM_PREFIXED, i), l(t, m.TRANSFORM_PREFIXED, f), o = n, a = r.actionTypeId, u = o.xValue, c = o.yValue, s = o.zValue, (a === I.TRANSFORM_MOVE && void 0 !== s || a === I.TRANSFORM_SCALE && void 0 !== s || a === I.TRANSFORM_ROTATE && (void 0 !== u || void 0 !== c)) && l(t, m.TRANSFORM_STYLE_PREFIXED, _.PRESERVE_3D)
                }(t, e, n, i, a);
            case _.RENDER_STYLE:
                    ...
                    switch (u) {
                        case I.STYLE_SIZE:
                            var s = r.config,
                                ...
                                E = n.widthValue,
                                h = n.heightValue;
                            void 0 !== E && (d === _.AUTO && (d = "px"), j(t, _.WIDTH, o), a(t, _.WIDTH, E + d)), void 0 !== h && (v === _.AUTO && (v = "px"), j(t, _.HEIGHT, o), a(t, _.HEIGHT, h + v));
                            break;
                        case I.STYLE_FILTER:
                            ! function(t, e, n, r) {
                                var i = (0, l.default)(e, function(t, e, r) {
                                        return "".concat(t, " ").concat(r, "(").concat(e).concat(X(r, n), ")")
                                    }, ""),
                                    o = r.setStyle;
                                j(t, _.FILTER, r), o(t, _.FILTER, i)
                            }(t, n, c, o);
                            break;
                        case I.STYLE_BACKGROUND_COLOR:
                        case I.STYLE_BORDER:
                        case I.STYLE_TEXT_COLOR:
                            var g = O[u],
                                ...
                                b = n.aValue;
                            j(t, g, o), a(t, g, b >= 1 ? "rgb(".concat(y, ",").concat(m, ",").concat(T, ")") : "rgba(".concat(y, ",").concat(m, ",").concat(T, ",").concat(b, ")"));
                            break;
                        default:
                            var S = c.unit,
                                R = void 0 === S ? "" : S;
                            j(t, i, o), a(t, i, n.value + R)
                    }
                }(t, 0, n, i, o, a);
        ...
        return n.forEach(function(t, e) {
            if (!r || 0 !== e) {
                var n = t.actionItems,
                    ...
                    f = o.actionTypeId;
                i.id === o.id && (c = u + a);
                var l = D(f) === _.RENDER_GENERAL ? 0 : s.duration;
                u += s.delay + l
            }
    ...
    var f = s(n(188)),
        ...
        b = Object.freeze((i = {}, (0, c.default)(i, m.TRANSFORM_PREFIXED, _.TRANSFORM), (0, c.default)(i, _.BACKGROUND_COLOR, _.BACKGROUND), (0, c.default)(i, _.OPACITY, _.OPACITY), (0, c.default)(i, _.FILTER, _.FILTER), (0, c.default)(i, _.WIDTH, _.WIDTH), (0, c.default)(i, _.HEIGHT, _.HEIGHT), i)),
        S = {},
        R = 1,
        A = 1,
        w = function(t, e) {
    ...
    function L(t) {
        ...
        var w, L, C, P = (0, p.default)(n, "action.config.affectedElements", {})[g || T] || {},
            x = Boolean(P.id || P.selector),
            D = n && u(N(n.target));
        if (x ? (w = P.limitAffectedElements, L = D, C = u(P)) : L = C = u({
                id: g,
                selector: T,
                selectorGuids: O
            }), n && R) {
            var M = r && (C || !0 === R) ? [r] : c(D);
            if (C) {
                if (R === _.PARENT) return c(C).filter(function(t) {
                    return M.some(function(e) {
                        return d(t, e)
                    })
                });
                if (R === _.CHILDREN) return c(C).filter(function(t) {
                    return M.some(function(e) {
                        return d(e, t)
                    })
                });
                if (R === _.SIBLINGS) return c(C).filter(function(t) {
                    return M.some(function(e) {
                        return v(e, t)
                    })
                })
        ...
        return null == L || null == C ? [] : m.IS_BROWSER_ENV && i ? c(C).filter(function(t) {
            return i.contains(t)
        }) : w === _.CHILDREN ? c(L, C) : w === _.IMMEDIATE_CHILDREN ? s(c(L)).filter(l(C)) : w === _.SIBLINGS ? f(c(L)).filter(l(C)) : c(C)
    }
    var C = /px/,
        P = function(t, e) {
    ...
    function B(t) {
        ...
        e.actionItems.forEach(function(t) {
            var e, i = t.actionTypeId,
                o = t.config;
            e = (0, g.isPluginType)(i) ? (0, g.clearPlugin)(i) : z({
                effect: W,
                actionTypeId: i,
                elementApi: r
            }), L({
    ...
    function W(t, e, n) {
        var r = n.setStyle;
        H(t, e, n), r(t, e, ""), e === m.TRANSFORM_PREFIXED && r(t, m.TRANSFORM_STYLE_PREFIXED, "")
    }
    ...
    e.ixSession = function() {
        ...
        switch (e.type) {
            ...
            case v:
                for (var S = e.payload, R = S.width, A = S.mediaQueries, w = A.length, N = null, L = 0; L < w; L++) {
                    var C = A[L],
                        P = C.key,
                        x = C.min,
                        D = C.max;
    ...
    var r = n(2),
        ...
        I = function(t, e) {
            ...
            for (var b = 0, S = o.length; b < S; b++) {
                ...
                if (0 === b && (E = w[0]), O >= A) {
                    ...
                    var N = o[b + 1],
                        L = N && O !== A;
                    h = L ? N.actionItems[0] : null, L && (_ = A / 100, y = (N.keyframe - A) / 100)
                }
            }
            var C = {};
            if (E && !h)
                for (var P = 0, x = a.length; P < x; P++) {
                    ...
                    for (var M = (T - _) / y, F = E.config.easing, X = v(F, M), U = 0, G = a.length; U < G; U++) {
                        var V = a[U],
                            j = g(s, V, E.config),
                            H = (g(s, V, h.config) - j) * X + j;
                        C[V] = H
                    }
            return (0, i.merge)(t, {
                position: T,
        ...
        m = function(t, e) {
            var n = t,
                ...
                I = y.duration,
                m = y.delay;
            null != h && (I = h), m = null != g ? g : m, c === E ? I = 0 : u && (I = m = 0);
            var T = e.payload.now;
            if (r && o) {
                var O = T - (a + m);
                if (s) {
                    var b = T - a,
                        S = I + m,
                        R = p(Math.min(Math.max(0, b / S), 1));
                    t = (0, i.set)(t, "verboseTimeElapsed", S * R)
                }
                if (O < 0) return t;
                var A = p(Math.min(Math.max(0, O / I), 1)),
                    w = v(_, A),
                    N = {},
                    L = null;
                return d.length && (L = d.reduce(function(t, e) {
                    ...
                    return t[e] = i, t
                }, {})), N.current = L, N.position = A, 1 === A && (N.active = !1, N.complete = !0), (0, i.merge)(t, N)
            }
            return t
        };
    e.ixInstances = function() {
        ...
        switch (e.type) {
            ...
            case f:
                ...
                if (!t[H]) return t;
                for (var k = {}, B = Object.keys(t), z = B.length, W = 0; W < z; W++) {
                    var Y = B[W];
                    Y !== H && (k[Y] = t[Y])
                }
                return k;
    ...
    t.exports = function(t, e, n) {
        ...
        function y(t) {
            var n = t - p;
            return void 0 === p || n >= e || n < 0 || h && t - v >= f
        }
        ...
        function I() {
            ...
            d = setTimeout(I, function(t) {
                var n = e - (t - p);
                return h ? u(n, f - (t - v)) : n
            }(t))
        }

        function m(t) {
            return d = void 0, g && c ? _(t) : (c = s = void 0, l)
        }
        ...
        function T() {
            ...
            if (c = arguments, s = this, p = t, n) {
                if (void 0 === d) return function(t) {
                    return v = t, d = setTimeout(I, e), E ? _(t) : l
                }(p);
                if (h) return clearTimeout(d), d = setTimeout(I, e), _(p)
            }
            return void 0 === d && (d = setTimeout(I, e)), l
        }
        return e = o(e) || 0, r(n) && (E = !!n.leading, f = (h = "maxWait" in n) ? a(o(n.maxWait) || 0, e) : f, g = "trailing" in n ? !!n.trailing : g), T.cancel = function() {
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        return null != t && "object" == (0, r.default)(t) ? t instanceof Element ? c : s : null
    ...
    var i = n(2),
        ...
        s = a.PLAIN_OBJECT,
        f = a.WF_PAGE,
        l = Element.prototype.closest ? function(t, e) {
    ...
    var c, s, f, l = u(n(26)),
        ...
        X = _.COMPONENT_INACTIVE,
        U = _.SCROLL_OUT_OF_VIEW,
        G = _.PAGE_SCROLL_UP,
        V = _.SCROLLING_IN_VIEW,
        j = _.PAGE_FINISH,
        H = _.ECOMMERCE_CART_CLOSE,
        ...
        dt = function(t) {
            return function(e, n) {
                var r = e.nativeEvent.type,
                    i = -1 !== [F, X].indexOf(r) ? r === F : n.isActive,
                    o = (0, l.default)({}, n, {
                        isActive: i
                    });
        ...
        vt = function(t) {
            return function(e) {
                ...
                var E, h, g = (d ? f : a * (f || 0) / 100) / p,
                    _ = 0;
                n && (E = v > n.percentTop, _ = (h = n.scrollingDown !== E) ? v : n.anchorTop);
        ...
        yt = (r = {}, (0, o.default)(r, A, ht()), (0, o.default)(r, w, gt()), (0, o.default)(r, R, ht()), (0, o.default)(r, S, gt()), (0, o.default)(r, P, ht(!1)), (0, o.default)(r, C, gt(!1)), (0, o.default)(r, N, ht()), (0, o.default)(r, L, gt()), (0, o.default)(r, k, {
            ...
            handler: function(t) {
                ...
                switch (u) {
                    ...
                    case K:
                        var A = st(),
                            ...
                            L = A.scrollWidth,
                            C = A.scrollHeight;
                        b = T ? Math.min(w + y, L) / L : Math.min(N + m, C) / C;
                        break;
                    case W:
                    default:
                        S = q(o, s);
                ...
                return O && (b > .95 || b < .05) && (b = Math.round(b)), (u !== W || R || R !== a.elementHovered) && (b = f ? 1 - b : b, e.dispatch((0, h.parameterChanged)(S, b))), {
                    elementHovered: R,
                    clientX: v,
                    clientY: g,
                    pageX: y,
            ...
            handler: function(t) {
                ...
                if (d === Y) {
                    ...
                    return b !== o.scrollPercent && n.dispatch((0, h.parameterChanged)(v, b)), {
                        scrollPercent: b
                    }
                }
                var S = q(i, v),
                    ...
                    w = (_ ? O : 0) / 100;
                A = E ? A : 1 - A, w = g ? w : 1 - w;
                var N = R.top + Math.min(R.height * A, l),
                    L = R.top + R.height * w - N,
                    C = Math.min(l + L, f),
                    P = Math.min(Math.max(0, l - N), C) / C;
                return P !== o.scrollPercent && n.dispatch((0, h.parameterChanged)(S, P)), {
                    scrollPercent: P
                }
            }
        }), (0, o.default)(r, M, _t), (0, o.default)(r, U, _t), (0, o.default)(r, D, (0, l.default)({}, ut, {
            handler: vt(function(t, e) {
                e.scrollingDown && nt(t)
            })
        })), (0, o.default)(r, G, (0, l.default)({}, ut, {
            handler: vt(function(t, e) {
                e.scrollingDown || nt(t)
            })
        })), (0, o.default)(r, j, {
                                            ...
                                            ! function(e, r) {
                                                ...
                                                ! function t() {
                                                    ...
                                                    n.scroll(0, function(t, e, n, r) {
                                                        return n > l ? o : t + (o - t) * ((i = n / l) < .5 ? 4 * i * i * i : (i - 1) * (2 * i - 2) * (2 * i - 2) + 1);
                                                        var i
                                                    }(i, 0, e)), e <= l && f(t)
                                                }()
                                            }(c, l)
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function I(e, n) {
            ...
            i.done = a.find("> .w-form-done"), i.fail = a.find("> .w-form-fail"), i.fileUploads = a.find(".w-file-upload"), i.fileUploads.each(function(e) {
                ! function(e, n) {
                    if (n.fileUploads && n.fileUploads[e]) {
                        ...
                        if (g) f.on("click", function(t) {
                            ...
                            E.on("click", function() {
                                ...
                                (r = i.target && i.target.files && i.target.files[0]) && (o.toggle(!1), s.toggle(!1), a.toggle(!0), h.text(r.name), A() || T(n), n.fileUploads[e].uploading = !0, function(e, n) {
                                    var r = {
                                        name: e.name,
                                        size: e.size
                                    };
                    ...
                    function R(t) {
                        if (t) return b(t);
                        a.toggle(!1), u.css("display", "inline-block"), n.fileUploads[e].uploading = !1, A() || m(n)
                    }
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), _.test(u) ? i.handler = S : u || (o ? i.handler = b : y())
        }
        ...
        function O(e, n) {
            ...
            return n = n || {}, e.find(':input:not([type="submit"]):not([type="file"])').each(function(i, o) {
                ...
                "string" == typeof s && (s = t.trim(s)), n[c] = s, r = r || function(t, e, n, r) {
                    var i = null;
                    return "password" === u ? i = "Passwords cannot be submitted." : t.attr("required") ? r ? v.test(t.attr("type")) && (E.test(r) || (i = "Please enter a valid email address for: " + n)) : i = "Please fill out the required field: " + n : "g-recaptcha-response" !== n || r || (i = "Please confirm youтАЩre not a robot."), i
                }(a, 0, c, s)
            }), r
        }
        ...
        return s.ready = s.design = s.preview = function() {
            o = t("html").attr("data-wf-site"), u = "https://webflow.com/api/v1/form/" + o, d && u.indexOf("https://webflow.com") >= 0 && (u = u.replace("https://webflow.com", "http://formdata.webflow.com")), c = "".concat(u, "/signFile"), (n = t(p + " form")).length && n.each(I), g || a || function() {
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function T(n, i) {
            ...
            c || (c = t.data(i, v, {
                ...
                return e.outside && l.off("tap" + v, e.outside),
                    function(n) {
                        var r = t(n.target);
                ...
                return function(n, r) {
                    r = r || {};
                    var i = f.width();
                    S(t), !0 === r.open && L(t, !0), !1 === r.open && P(t, !0), t.open && e.defer(function() {
                        i !== f.width() && R(t)
                    })
                }
            }(c))) : (function(e) {
                e.overlay || (e.overlay = t(p).appendTo(e.el), e.parent = e.menu.parent(), P(e, !0))
                ...
                return function(n) {
                    ...
                    r.validClick(n.currentTarget) ? i && 0 === i.indexOf("#") && e.open && P(e) : n.preventDefault()
                }
            }(c))), w(n, i)
        }
        ...
        c.ready = c.design = c.preview = function() {
            a = d && r.env("design"), u = r.env("editor"), n = t(document.body), (o = l.find(v)).length && (o.each(T), I(), r.resize.on(m))
        }, c.destroy = function() {
        ...
        function L(t, e) {
            if (!t.open) {
                t.open = !0, t.menu.addClass(h), t.links.addClass(g), t.button.addClass(E);
                var n = t.config;
                ...
                var i = C(t),
                    ...
                    c = t.el.height(),
                    f = t.el[0];
                if (w(0, f), _.intro(0, f), r.redraw.up(), a || l.on("tap" + v, t.outside), !e) {
    ...
    events: {
        e: {
            ...
            target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "5d365467dbdba4a2894cf9ed|df9cfcd5-caba-b87f-dc86-e96dd20d0d9c"
            },
            config: [{
                    ...
                    actionItems: [{
                        ...
                        config: {
                            ...
                            target: {
                                ...
                                selector: ".image-12",
                                selectorGuids: ["fd3f3f52-89d7-e011-f769-97104bb5011c"]
                            },
                            yValue: 1200,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".z7",
                                selectorGuids: ["882dcc38-77fd-1e44-0a7d-ace218fe06d6"]
                            },
                            yValue: 1e3,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-21",
                                selectorGuids: ["88a3e06b-dfad-33e7-afa8-9e74cfebddb1"]
                            },
                            yValue: 2e3,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".z6",
                                selectorGuids: ["065d3085-63b2-ee8e-4170-fdb757b613f0"]
                            },
                            yValue: 700,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-11",
                                selectorGuids: ["583b4017-a425-3d07-c52f-35ef0efae83b"]
                            },
                            yValue: 600,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-17",
                                selectorGuids: ["77192eea-e367-c6f4-c3b6-50bf317e1d07"]
                            },
                            yValue: 600,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-9",
                                selectorGuids: ["12649887-7bea-e3a8-6086-317a166e7394"]
                            },
                            yValue: 500,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-10",
                                selectorGuids: ["7d31de66-05d0-605f-799b-e041d1aa7feb"]
                            },
                            yValue: 500,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-8",
                                selectorGuids: ["734ddadd-8b2e-e1e9-3331-703ad9f6c0ab"]
                            },
                            yValue: 400,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".z5",
                                selectorGuids: ["6f3200fa-4f94-94fd-98c3-1dcf8675d866"]
                            },
                            yValue: 450,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-14",
                                selectorGuids: ["b88234b1-8b7c-109f-61fe-0445bc0d1b6f"]
                            },
                            yValue: 140,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".z2",
                                selectorGuids: ["5d8d5048-bfd6-499f-d5f9-90ae06559835"]
                            },
                            yValue: 140,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".z4",
                                selectorGuids: ["19dbc73b-2986-bae9-a1f5-756998e40a0e"]
                            },
                            yValue: 140,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".z3",
                                selectorGuids: ["27082527-e91d-b408-0c03-d0bd207a866b"]
                            },
                            yValue: 120,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-19",
                                selectorGuids: ["1e4699e2-0db6-532b-4fb4-5962e768ba58"]
                            },
                            yValue: 200,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-16",
                                selectorGuids: ["10c43595-7337-f58a-adcb-938b76aee8b3"]
                            },
                            yValue: 240,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-13",
                                selectorGuids: ["a0859366-bd1d-2ff1-7deb-77c4893ec03b"]
                            },
                            yValue: 150,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-20",
                                selectorGuids: ["db5050d1-2450-f6da-7b31-32214a950f5b"]
                            },
                            yValue: 300,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-22",
                                selectorGuids: ["0bdcde9f-98cf-bd6a-4b07-aa672ab3b0fb"]
                            },
                            yValue: 400,
                            xUnit: "PX",
                            yUnit: "PX",
                        ...
                        config: {
                            ...
                            target: {
                                useEventTarget: "CHILDREN",
                                selector: ".image-23",
                                selectorGuids: ["eb571e8c-d94e-8d4a-6105-a1f78c80ca1e"]
                            },
                            yValue: 400,
                            xUnit: "PX",
                            yUnit: "PX",
